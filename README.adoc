...
NOTE: These steps are for the maintainer.
...
See https://central.sonatype.org/publish/release/#releasing-deployment-from-ossrh-to-the-central-repository-introduction[Releasing Deployment from OSSRH] for the next steps.
